...
# curteosy of https://stackoverflow.com/questions/3173320/text-progress-bar-in-the-console
...
while True:
    ...
    if newline:
        f.write('\n')
    printProgressBar(current_size, 10**limit , prefix = 'Progress:', suffix = 'Complete', length = 50)
    i -=-1
